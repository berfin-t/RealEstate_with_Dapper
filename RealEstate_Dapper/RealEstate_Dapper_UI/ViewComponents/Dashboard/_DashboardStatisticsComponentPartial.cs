...
namespace RealEstate_Dapper_UI.ViewComponents.Dashboard
{
    public class _DashboardStatisticsComponentPartial : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMessage2 = await client2.GetAsync("https://localhost:44311/api/Statistics/EmployeeNameByMaxProductCount");
            ...
            var responseMessage3 = await client3.GetAsync("https://localhost:44311/api/Statistics/DifferentCityCount");
